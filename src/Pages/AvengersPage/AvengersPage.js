...
import {AvengersQuestion} from '../../RecoilState/AvengersQuizQuest/AvengersQuizQuest'
import style from './Avengers.module.css'
export default function AvengersPage(){
  ...
  const question = useRecoilValue(AvengersQuestion)
